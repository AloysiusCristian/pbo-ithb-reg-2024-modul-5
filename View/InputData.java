    ...
    public static void inputDataKTP(){
        ...
        confirmation.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                String tanggalLahirData = tanggalLahir.getDateFormatString();
                ...
                || tanggalPembuatanData.isEmpty() || profilPath.isEmpty() || ttdPath.isEmpty()) {
                    ...
                    KTP ktpBaru = new KTP(agamaData, alamatData, berlakuHinggaData, golonganDarahData, jenisKelaminData, 
                    kecamatanData, kelDesaData, kotaPembuatanData, namaData, 
                    negaraAsalData, nikData, pekerjaanData, profilPath, rtrwData, 
                    statusPerkawinanData, tanggalLahirData, tanggalPembuatanData, tempatLahirData, ttdPath);
